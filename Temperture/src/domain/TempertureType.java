 ...
 */
public abstract class TempertureType {
	...
	protected TempertureType(String name, String unit, double value) {
		this.name = name;
		this.unit = unit;
		this.value = value;
	}
	...
	public boolean equals(Object obj) {
		return this.equals((TempertureType) obj);
	}
	
	public boolean equals(TempertureType obj) {
